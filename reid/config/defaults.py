...
# Name of backbone
_C.MODEL.NAME = 'mobilenetv4'
_C.MODEL.BASE_CFG = './configs/RSYNet2.cfg'
_C.MODEL.BASE_WEIGHT = './checkpoints/latest.pth'
# Last stride of backbone   ./weights/rsynet.pt
_C.MODEL.LAST_STRIDE = 1
# Path to pretrained model of backbone
_C.MODEL.PRETRAIN_PATH = ''
# Use ImageNet pretrained model to initialize backbone or use self trained model to initialize the whole model
# Options: 'imagenet' or 'self'
_C.MODEL.PRETRAIN_CHOICE = 'latest'
...
_C.DATASETS.ROOT_DIR = ('E:/Datasets/Re_ID')
...
_C.TEST.WEIGHT = "./checkpoints/latest.pth"
