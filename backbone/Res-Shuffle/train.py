...
from utils import accuracy, AvgrageMeter, CrossEntropyLabelSmooth, save_checkpoint, get_lastest_model, get_parameters, model_info
...
def get_args():
    ...
    parser.add_argument('--total-iters', type=int, default=400000, help='total iters')
    ...
    parser.add_argument('--train-dir', type=str, default='E:/Datasets/ImageNet/ILSVRC2012_img_train', help='path to training dataset')
    parser.add_argument('--val-dir', type=str, default='E:/Datasets/ImageNet/ILSVRC2012_img_val', help='path to validation dataset')
