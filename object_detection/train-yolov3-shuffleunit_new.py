...
def train(
    ...
    latest = weights + 'yolov3-shuffleunit-large.pt'
    ...
    torch.save(model, 'yolov3-shuffleunit-new.pth')
    return
    ...
    if resume:
        ...
        #model.load_state_dict(torch.load('weights/dict_144.pth'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-shufflenet.cfg', help='cfg file path')
    parser.add_argument('--data-cfg', type=str, default='cfg/face.data', help='coco.data file path')
