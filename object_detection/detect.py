...
def detect(
    ...
    model.load_state_dict(torch.load(weights, map_location='cpu')['model'])
    #model.load_state_dict(torch.load('E:/workspace_python/Object Detection/yolov3-face-person/checkpoints/dict_199.pth'))
    ...
    classes = load_classes(parse_data_cfg('cfg/face.data')['names'])
