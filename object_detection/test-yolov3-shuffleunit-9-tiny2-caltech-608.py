...
def test(
    ...
    for batch_i, (imgs, targets, paths, shapes) in enumerate(dataloader):
        ...
        with open('../results/caltech608.txt', 'a') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-shuffleunit-9-tiny2-caltech-608.cfg', help='cfg file path')
    parser.add_argument('--data-cfg', type=str, default='cfg/caltech.data', help='coco.data file path')
    parser.add_argument('--weights', type=str, default='weights/yolov3-shuffleunit-9-tiny2-caltech-608.pt', help='path to weights file')
