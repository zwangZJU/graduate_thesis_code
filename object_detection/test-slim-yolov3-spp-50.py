...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/slim-yolov3-spp-50.cfg', help='cfg file path')
    parser.add_argument('--data-cfg', type=str, default='cfg/face-l.data', help='coco.data file path')
    parser.add_argument('--weights', type=str, default='weights/slim-yolov3-spp-50.pt', help='path to weights file')
