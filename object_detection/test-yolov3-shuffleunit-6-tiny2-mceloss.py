...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-shuffleunit-6-tiny2-mceloss.cfg', help='cfg file path')
    parser.add_argument('--data-cfg', type=str, default='cfg/face-l.data', help='coco.data file path')
    parser.add_argument('--weights', type=str, default='weights/yolov3-shuffleunit-6-tiny2-mceloss.pt', help='path to weights file')
