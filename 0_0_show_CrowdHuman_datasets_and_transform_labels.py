...
@Author: wzlab
@Date  : 2018/12/27
@Desc  : 1. 将odgt中的标签转化为标准的yolo标签； 2.随机展示图片及标注
'''
            ...
            with open(save_path+id+'.txt','a+') as fw:
                ...
                for boxes in data['gtboxes']:
                    ...
                    if boxes['head_attr']:
                        ...
                        hbox[2] = hbox[2] / w
                        hbox[3] = hbox[3] / h
                        if hbox[2]>thresh and hbox[3]>thresh:
...
if __name__ == '__main__':
    ...
    save_path = root_path + 'train/labels/'
    # train
    #transform(root_path + 'train/labels_train.txt', label_file, image_path, save_path)

    # val
    #transform(root_path + 'val/labels_val.txt', root_path + 'annotation_val.odgt', 'E:/Datasets/CrowdHuman/val/images/', root_path + 'val/labels/')
